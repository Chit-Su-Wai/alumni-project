                            ...
                            <tr class="border-t">
                                ...
                                <td class="p-3 align-middle">
                                    <div class="flex items-center gap-3 min-w-0">
                                        <img src="<?= !empty($user['profile_image']) ? htmlspecialchars($user['profile_image']) : '../images/default-avatar.svg' ?>" class="h-9 w-9 rounded-full object-cover border border-cyan-100 shrink-0">
                    ...
                    <table class="w-full table-fixed">
                        ...
                        <?php while($post = $latestPosts->fetch_assoc()): ?>
                            ...
                            <tr class="border-t">
                                ...
                                <td class="p-3 align-middle">
                                    <div class="flex items-center gap-3 min-w-0">
                                        <img src="<?= !empty($post['profile_image']) ? htmlspecialchars($post['profile_image']) : '../images/default-avatar.svg' ?>" class="h-9 w-9 rounded-full object-cover border border-cyan-100 shrink-0">
                                        <span class="truncate font-semibold"><?= htmlspecialchars($post['name']) ?></span>
                                    </div>
                                </td>

                                <td class="p-3 align-middle truncate">
                                    <?= htmlspecialchars(substr($post['content'], 0, 80)) ?><?= strlen($post['content']) > 80 ? '...' : '' ?>
                                </td>
